...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/FPImageVideoCell/FPImageVideoCell.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FPPermission/FPPermission.framework"
